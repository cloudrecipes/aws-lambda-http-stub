...
exports.main = (data, services) => {
  ...
  switch (method) {
    ...
    case 'PUT': return exports.updateResource(data)
    case 'POST': return exports.createResource(data)
    case 'DELETE': return exports.deleteResource(data)
...
exports.createResource = ({is4xx, is5xx, id}) =>
  (is4xx || is5xx
    ? httpResponseFactory(is4xx || is5xx)
    : httpResponseFactory(201, {id}))

exports.updateResource = ({is4xx, is5xx}) => httpResponseFactory(is4xx || is5xx || 204)

exports.deleteResource = ({is5xx}) => httpResponseFactory(is5xx || 204)
